...
while True:
    ...
    uper_color = np.array([17,255,255], np.uint8)
    ...
    if len(contours) > 0:
        ...
        try:
            ...
            cv2.putText(roi, str(angle_ab), (extRight[0]-100+50, extRight[1]), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 2, cv2.LINE_4)
        
        except:
            cv2.putText(roi, "?", (extRight[0]-100+50, extRight[1]), cv2.FONT_HERSHEY_COMPLEX, 1, (255,0,0), 2, cv2.LINE_4)
